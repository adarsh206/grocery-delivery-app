...
const InputField = ({type, placeholder, name, handleChange, address}) => (
    <input className='w-full px-2 py-2.5 border border-gray-500/30 rounded outline-none text-gray-500 
     focus:border-primary transition focus:shadow-2xl focus: shadow-green-500' 
    type={type}
...
const AddAddress = () => {
  ...
  return (
    <div className='mt-16 pb-16'>
        ...
        <span className='font-semibold text-primary pl-2'>Address</span></p>
          ...
          <div className='flex-1 max-w-md'>
            <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
              ...
              <InputField handleChange={handleChange} address={address}
                ...
                cursor-pointer uppercase'>Save Address</button>
            </form>
          </div>
